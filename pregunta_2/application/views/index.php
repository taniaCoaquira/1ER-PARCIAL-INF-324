...
<div id="contenido">
    <div id="lista">
        <div class="parrafo">
            <img src="http://localhost:8081/pregunta2/public/uploads/univ.jpg" alt="">
        ...
        <div class="parrafo">
            <img src="http://localhost:8081/pregunta2/public/uploads/lic.jpg" alt="">
            <h1>LICENCIATURA</h1>
            <p>
        ...
        <div class="parrafo">
            <img src="http://localhost:8081/pregunta2/public/uploads/maest.jpg" alt="">
            <h1>MAESTRÍA</h1>
            <p>
